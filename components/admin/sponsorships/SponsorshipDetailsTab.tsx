  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-8 rounded-lg border border-slate-200 bg-white p-6">
        <DetailItem label="Sponsor type" value={sponsorship.sponsorType} />
        <DetailItem label="Sponsor name" value={sponsorship.sponsorName} />
        <DetailItem label="Child name" value={sponsorship.childName} />
        <DetailItem label="Status" value={sponsorship.status} />
        <DetailItem label="Start date" value={sponsorship.startDate} />
        <DetailItem label="Sponsorship ID" value={sponsorship.id} />
      </div>
      ...
      <div className="rounded-lg border border-slate-200 bg-white p-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          <DetailItem label="Phone number" value={sponsorship.phoneNumber} />
          <DetailItem label="Email" value={sponsorship.email} />
        </div>
      </div>
    </div>
  );

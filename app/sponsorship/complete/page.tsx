...
const planPrice: Record<Frequencies, { value: string; suffix: string }> = {
...
export default function CompleteSponsorshipPage() {
	...
	const [planType, setPlanType] = React.useState<Frequencies>("monthly");
			...
			<div className="mx-auto w-full max-w-3xl px-4 py-10">
				...
				<div className="mt-8">
					<p className="mb-3 text-sm text-foreground">
						Select Sponsorship Plan
					</p>

					<Tabs
						selectedKey={planType}
						onSelectionChange={(key) => setPlanType(key as Frequencies)}
						variant="bordered"
						radius="md"
						color="primary"
						disableAnimation
				...
				<Card className="mt-6 rounded-[12px] border border-default-200 shadow-none">
					<CardBody className="p-6">
						...
						<div className="mt-5 grid grid-cols-1 gap-4">
							...
							>
								{Object.entries(SPONSOR_TYPE_LABELS).map(([key, value]) => (
									<SelectItem
										key={key}
										classNames={{
											selectedIcon: "hidden",
